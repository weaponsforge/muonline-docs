...
import { appShortName } from '@/lib/constants'
...
const font = readFile('src/lib/og/JetBrainsMono-Regular.ttf').then((data) => ({
  name: 'JetBrainsMono',
  data,
  weight: 400,
}))

const fontBold = readFile('src/lib/og/JetBrainsMono-Bold.ttf').then((data) => ({
  name: 'JetBrainsMono',
  data,
  weight: 600,
}))
